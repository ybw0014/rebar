 ...
 */
interface VanillaInventoryRebarBlockHandler {
    ...
    companion object : MultiListener {
        ...
        private fun onInventoryOpen(event: InventoryOpenEvent, priority: EventPriority) {
            ...
            if (holder is BlockInventoryHolder) {
                ...
                if (rebarBlock is VanillaInventoryRebarBlockHandler) {
                    try {
        ...
        private fun onItemMove(event: InventoryMoveItemEvent, priority: EventPriority) {
            ...
            if (sourceHolder is BlockInventoryHolder) {
                ...
                if (sourceBlock is VanillaInventoryRebarBlockHandler) {
                    try {
            ...
            if (destHolder is BlockInventoryHolder) {
                ...
                if (destBlock is VanillaInventoryRebarBlockHandler) {
                    try {
