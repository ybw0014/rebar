 ...
 */
interface EntityChangeRebarBlockHandler {
    fun onEntityChangeBlock(event: EntityChangeBlockEvent, priority: EventPriority) {}
    ...
    companion object : MultiListener {
        ...
        private fun onEntityChangeBlock(event: EntityChangeBlockEvent, priority: EventPriority) {
            ...
            if (rebarBlock is EntityChangeRebarBlockHandler) {
                try {
                    MultiHandlers.handleEvent(rebarBlock, "onEntityChangeBlock", event, priority)
                } catch (e: Exception) {
