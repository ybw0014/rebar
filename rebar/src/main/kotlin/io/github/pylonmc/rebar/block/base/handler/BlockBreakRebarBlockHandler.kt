...
interface BlockBreakRebarBlockHandler {
     ...
     */
    fun onPreBlockBreak(context: BlockBreakContext): Boolean {
        return true
    }
     ...
     */
    fun onBlockBreak(drops: MutableList<ItemStack>, context: BlockBreakContext) {}
     ...
     * In the case of a vanilla [BlockBreakEvent] this is called during the monitor priority.
     */
    fun onPostBlockBreak(context: BlockBreakContext) {}
}