...
interface JobRebarBlockHandler {
    fun onVillagerAcquireJob(event: VillagerCareerChangeEvent, priority: EventPriority) {}

    @ApiStatus.Internal
    companion object : MultiListener {
        @UniversalHandler
        private fun onVillagerAcquireJob(event: VillagerCareerChangeEvent, priority: EventPriority) {
            ...
            if (rebarBlock is JobRebarBlockHandler) {
                try {
